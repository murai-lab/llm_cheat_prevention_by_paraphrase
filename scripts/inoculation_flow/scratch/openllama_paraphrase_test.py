# Paraphrasing test using openLLama
# Jeremy Lim
# jlim@wpi.edu
...
def main(num_qs=15, num_paraphrases=10):
    ...
    max_new_tokens = 40 # To confirm that it can actually run!
    ...
    # Trying this model: https://huggingface.co/openlm-research/open_llama_3b_v2
    mdl_path = 'openlm-research/open_llama_3b_v2'
    ...
    # outputs = pipe(test_question, max_new_tokens=20, do_sample=False)
    ...
    for q in q_list:
        ...
        # JL - template 2
        mdl_prompt_template = "Please paraphrase the following question in quotes: \"{}\""
